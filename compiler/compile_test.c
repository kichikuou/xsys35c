...
static void test(const char *name, const char *source,
	...
	compiler_init(&compiler, src_names, NULL, NULL);
...
int main() {
	...
	TEST("var-ref",
		 "!a:0!!b:a!!a:b!",
		 "\x21\x80\x40\x7f\x21\x81\x80\x7f\x21\x80\x81\x7f");
	TEST("array-ref",
		 "!A[1]:A[2]!",
	...
	TEST("function",
		 ...
		 "\x21\x80\x40\x7f\x21\x81\x40\x7f\x7e\x00\x00\x80\x7f\x21\x81\x41"
		 "\x7f\x21\x80\x42\x7f\x7e\x01\x00\x28\x00\x00\x00");
	TEST("function-fw",
