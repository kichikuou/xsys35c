...
diff -u --strip-trailing-cr - <(TZ=UTC tools/pms -i --system2 testdata/*.pms) <<EOF
...
tools/pms --system2 testdata/256colors_sys2.pms -o $tmpfile && cmp testdata/256colors_nomask.png $tmpfile
tools/pms -e --system2 testdata/256colors_nomask.png -o $tmpfile && cmp testdata/256colors_sys2.pms $tmpfile
