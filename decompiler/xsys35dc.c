...
static const char short_options[] = "adE:ho:suVv";
...
static void usage(void) {
	...
	puts("    -u, --unicode             Decompile Unicode ALD (generated by xsys35c -u)");
...
Sco *sco_new(const char *name, const uint8_t *data, int len, int volume) {
	...
	if (!memcmp(data, "S350", 4))
		...
		error("%s: unknown SCO signature", to_utf8(name));
...
int main(int argc, char *argv[]) {
	...
	if (config.utf8_input && !config.utf8_output)
		error("-Es option cannot be used with -u.");
